...
def train(year=2023, model_name="scibert"):
    ...
    if model_name == "bert":
        ...
        BERT_MODEL = "bayartsogt/structbert-large"
    else:
...
def gen_kddcup_test_submission_bert(model_name="scibert"):
    ...
    utils.dump_json(sub_dict, join(settings.OUT_DIR, "kddcup", model_name), "test_submission_scibert.json")
...
if __name__ == "__main__":
    ...
    gen_kddcup_test_submission_bert(model_name="scibert")
